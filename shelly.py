    ...
    while True:
        ...
        if error:
            ...
            if result.error:
                ...
                sell = [26, 'OTHER', 26, 0, 26, 'KAMAU', 26, 1, 26, 253, 26, '5feceb66ffc86f38d952786c6d696c79c2dbc239dd4e91b46729d73a27fb57e9', 26, 'dfgh', 26, 453, 26, 'SELL', 14]
                buy = [26, 'PURITY', 26, 0, 26, 'dfgs', 26, 1, 26, 253, 26, '5feceb66ffc86f38d952786c6d696c79c2dbc239dd4e91b46729d73a27fb57e9', 26, 'dfgh', 26, 453, 26, 'BUY', 14]
