    ...
    while True:
        ...
        if error:
            ...
            if result.error:
                ...
                vm_ = VM([0, 'trades', 0, 'dead_sick', 0, 'sales', 0, 'purchases', 0, 'world_state', 0, 'eggs_collected', 20, 20, 20, 20, 20, 20]+create_instr('purchases')+[0, 'dead_sick', 0, 1, 1, 0, 1, 1, 24, 25, 14, 26]+end[:-1]+[37, 38, 39, 31])
                #cops = CommonOps()
